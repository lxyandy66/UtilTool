 ...
 * 
 */
public class PlotPanelMouseListener implements MouseListener, MouseMotionListener {
	private PlotPanel panle = null;
	private int downX;
	private int downY;

	public PlotPanelMouseListener(PlotPanel panle) {
		super();
		this.panle = panle;
	}
